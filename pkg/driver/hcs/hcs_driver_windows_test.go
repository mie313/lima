...
func TestValidateConfig(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			cfg: &limatype.LimaYAML{
				VMType: ptr.Of(limatype.HCS),
				Arch:   ptr.Of(limatype.Arch("unknown")),
			},
		...
		},
		{
			...
			cfg: &limatype.LimaYAML{
				VMType: ptr.Of(limatype.HCS),
				Arch:   &arch,
				Audio:  limatype.Audio{Device: ptr.Of("none")},
...
func TestValidate(t *testing.T) {
	...
	l.Instance.Config.TPM = ptr.Of(true)
